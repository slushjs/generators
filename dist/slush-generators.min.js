...
!function(e,t,r){"use strict";function n(){function e(e,r){return t.extend(Object.create(e),r)}function r(e,t){var r=t.caseInsensitiveMatch,n={originalPath:e,regexp:e},a=n.keys=[];return e=e.replace(/([().])/g,"\\$1").replace(/(\/)?:(\w+)([\?\*])?/g,function(e,t,r,n){var o="?"===n?n:null,i="*"===n?n:null;return a.push({name:r,optional:!!o}),t=t||"",""+(o?"":t)+"(?:"+(o?t:"")+(i&&"(.+?)"||"([^/]+)")+(o||"")+")"+(o||"")}).replace(/([\/$\*])/g,"\\$1"),n.regexp=new RegExp("^"+e+"$",r?"i":""),n}var n={};this.when=function(e,a){var o=t.copy(a);if(t.isUndefined(o.reloadOnSearch)&&(o.reloadOnSearch=!0),t.isUndefined(o.caseInsensitiveMatch)&&(o.caseInsensitiveMatch=this.caseInsensitiveMatch),n[e]=t.extend(o,e&&r(e,o)),e){var i="/"==e[e.length-1]?e.substr(0,e.length-1):e+"/";n[i]=t.extend({redirectTo:e},r(i,o))}return this},this.caseInsensitiveMatch=!1,this.otherwise=function(e){return"string"==typeof e&&(e={redirectTo:e}),this.when(null,e),this},this.$get=["$rootScope","$location","$routeParams","$q","$injector","$templateRequest","$sce",function(r,a,o,i,c,l,s){function h(e,t){var r=t.keys,n={};if(!t.regexp)return null;var a=t.regexp.exec(e);if(!a)return null;for(var o=1,i=a.length;i>o;++o){var c=r[o-1],u=a[o];c&&u&&(n[c.name]=u)}return n}function $(e){var n=w.current;v=d(),m=v&&n&&v.$$route===n.$$route&&t.equals(v.pathParams,n.pathParams)&&!v.reloadOnSearch&&!g,m||!n&&!v||r.$broadcast("$routeChangeStart",v,n).defaultPrevented&&e&&e.preventDefault()}function f(){var e=w.current,n=v;m?(e.params=n.params,t.copy(e.params,o),r.$broadcast("$routeUpdate",e)):(n||e)&&(g=!1,w.current=n,n&&n.redirectTo&&(t.isString(n.redirectTo)?a.path(p(n.redirectTo,n.params)).search(n.params).replace():a.url(n.redirectTo(n.pathParams,a.path(),a.search())).replace()),i.when(n).then(function(){if(n){var e,r,a=t.extend({},n.resolve);return t.forEach(a,function(e,r){a[r]=t.isString(e)?c.get(e):c.invoke(e,null,null,r)}),t.isDefined(e=n.template)?t.isFunction(e)&&(e=e(n.params)):t.isDefined(r=n.templateUrl)&&(t.isFunction(r)&&(r=r(n.params)),t.isDefined(r)&&(n.loadedTemplateUrl=s.valueOf(r),e=l(r))),t.isDefined(e)&&(a.$template=e),i.all(a)}}).then(function(a){n==w.current&&(n&&(n.locals=a,t.copy(n.params,o)),r.$broadcast("$routeChangeSuccess",n,e))},function(t){n==w.current&&r.$broadcast("$routeChangeError",n,e,t)}))}function d(){var r,o;return t.forEach(n,function(n,i){!o&&(r=h(a.path(),n))&&(o=e(n,{params:t.extend({},a.search(),r),pathParams:r}),o.$$route=n)}),o||n[null]&&e(n[null],{params:{},pathParams:{}})}function p(e,r){var n=[];return t.forEach((e||"").split(":"),function(e,t){if(0===t)n.push(e);else{var a=e.match(/(\w+)(?:[?*])?(.*)/),o=a[1];n.push(r[o]),n.push(a[2]||""),delete r[o]}}),n.join("")}var v,m,g=!1,w={routes:n,reload:function(){g=!0;var e={defaultPrevented:!1,preventDefault:function(){this.defaultPrevented=!0,g=!1}};r.$evalAsync(function(){$(e),e.defaultPrevented||f()})},updateParams:function(e){if(!this.current||!this.current.$$route)throw u("norout","Tried updating route when with no current route");e=t.extend({},this.current.params,e),a.path(p(this.current.$$route.originalPath,e)),a.search(e)}};return r.$on("$locationChangeStart",$),r.$on("$locationChangeSuccess",f),w}]}function a(){this.$get=function(){return{}}}function o(e,r,n){return{restrict:"ECA",terminal:!0,priority:400,transclude:"element",link:function(a,o,i,c,u){function l(){f&&(n.cancel(f),f=null),h&&(h.$destroy(),h=null),$&&(f=n.leave($),f.then(function(){f=null}),$=null)}function s(){var i=e.current&&e.current.locals,c=i&&i.$template;if(t.isDefined(c)){var s=a.$new(),f=e.current,v=u(s,function(e){n.enter(e,null,$||o).then(function(){!t.isDefined(d)||d&&!a.$eval(d)||r()}),l()});$=v,h=f.scope=s,h.$emit("$viewContentLoaded"),h.$eval(p)}else l()}var h,$,f,d=i.autoscroll,p=i.onload||"";a.$on("$routeChangeSuccess",s),s()}}}function i(e,t,r){return{restrict:"ECA",priority:-400,link:function(n,a){var o=r.current,i=o.locals;a.html(i.$template);var c=e(a.contents());if(o.controller){i.$scope=n;var u=t(o.controller,i);o.controllerAs&&(n[o.controllerAs]=u),a.data("$ngControllerController",u),a.children().data("$ngControllerController",u)}n[o.resolveAs||"$resolve"]=i,c(n)}}}var c=t.module("ngRoute",["ng"]).provider("$route",n),u=t.$$minErr("ngRoute");c.provider("$routeParams",a),c.directive("ngView",o),c.directive("ngView",i),o.$inject=["$route","$anchorScroll","$animate"],i.$inject=["$compile","$controller","$route"]}(window,window.angular);
...
"use strict";var angular=require("angular"),ngRoute=require("angular-route"),GeneratorsCtrl=require("./generators/generators-controller.js"),generatorsTemplate=require("./generators/generators-template.js");angular.module("slushSite",[ngRoute,GeneratorsCtrl,generatorsTemplate]).config(["$routeProvider",function(e){e.when("/",{controller:GeneratorsCtrl,templateUrl:generatorsTemplate}).otherwise({redirectTo:"/"})}]);
},{"./generators/generators-controller.js":12,"./generators/generators-template.js":13,"angular":4,"angular-route":2}],12:[function(require,module,exports){
"use strict";var url=require("url"),angular=require("angular"),GeneratorsCtrl="GeneratorsCtrl";module.exports=GeneratorsCtrl,angular.module(GeneratorsCtrl,[]).controller(GeneratorsCtrl,["$scope","$http","$log","$filter","$timeout",function(e,t,a,r,o){function n(r){if(e.loaded)return r();var n={fields:"name,keywords,rating,description,author,modified,homepage,version,license",q:"keywords:"+i.join(","),size:l,start:0,sort:"rating:desc"};t.get(u,{params:n}).success(function(a){var s=a.results||[];g.push.apply(g,s),e.hits=g.slice(),e.total=e.hits.length,e.loaded=!0,o(r,0),a.total>g.length&&(n.size=a.total-l,n.start=l,t.get(u,{params:n}).success(function(t){g.push.apply(g,t.results),e.total=g.length}))})["catch"](function(e){a.error(e)})}function s(){n(function(){var t=e.search?r("filter")(g,e.search):g;e.total=t.length,e.hits=t.slice((e.page-1)*l,e.page*l)})}var l=20,u="http://npmsearch.com/query",i=["slushgenerator"],g=[];e.page=1,e.loaded=!1,e.unique=function(e){for(var t=[],a=0,r=e.length;r>a;a++)t.indexOf(e[a])<0&&t.push(e[a]);return t},e.$watch("total",function(t){"number"==typeof t&&(e.totalPages=Math.ceil(t/l))}),e.$watch("page",function(){s()}),e.$watch("search",function(t,a){t!==a&&(1===e.page?s():e.page=1)}),e.hasHomepage=function(e){return e.homepage&&e.homepage[0]&&"undefined"!==e.homepage[0]},e.getRepoName=function(e){var t=e.homepage&&e.homepage[0];if(t&&"undefined"!==t){var a=url.parse(t);if(a&&a.pathname)return a.pathname.slice(1).replace(/(\.git|#.*)$/,"")}return e.author[0]+"/"+e.name[0]},e.getPage=function(t){t?t>e.totalPages&&(t=e.totalPages):t=1,e.page=t},e.getPages=function(){var t=9,a=[],r=1,o=t;e.totalPages<=t?(r=1,o=e.totalPages):(r=e.page-Math.floor(t/2),o=e.page+Math.floor(t/2),1>r?(o+=Math.abs(r)+1,r=1):o>e.totalPages&&(r-=o-e.totalPages,o=e.totalPages));for(var n=r;o>=n;n++)a.push(n);return a}}]);

},{"angular":4,"url":9}],13:[function(require,module,exports){
(function (__filename){
"use strict";var angular=require("angular"),template=require("./generators.html");module.exports=__filename,angular.module(__filename,[]).run(["$templateCache",function(e){e.put(__filename,template)}]);

}).call(this,"/src/app/generators/generators-template.js")
},{"./generators.html":14,"angular":4}],14:[function(require,module,exports){
module.exports='<h2>Generators <small class="pull-right generator-count">{{total}}</small></h2>\n\n<div class="form-group search-form">\n  <input type="text" class="form-control search-field" ng-model="search" placeholder="Filter" id="search-field">\n  <label class="search-field-icon fui-search" for="search-field"></label>\n</div>\n\n<div class="row generator-item" ng-repeat="hit in hits">\n  <div class="col-sm-7">\n    <h3>\n      <a href="https://www.npmjs.org/package/{{hit.name[0]}}">{{hit.name[0]}}</a>\n      <small>{{hit.version[0]}}</small>\n    </h3>\n    <p>{{hit.description[0]}}</p>\n  </div>\n  <div class="col-sm-5 text-right">\n    <h3>\n      <small>\n        <a ng-if="hasHomepage(hit)" ng-href="{{hit.homepage[0]}}" class="link-secondary">{{getRepoName(hit)}}</a>\n        <span ng-if="!hasHomepage(hit)" title="No homepage">{{getRepoName(hit)}}</span>\n      </small>\n    </h3>\n    <p>\n      <a href="" ng-repeat="keyword in unique(hit.keywords)" class="label pull-right" ng-class="{\'label-primary\': keyword === \'slushgenerator\', \'label-default\': keyword !== \'slushgenerator\'}">{{keyword}}</a>\n    </p>\n  </div>\n</div>\n<div ng-if="loading">\n  <p>Loading...</p>\n</div>\n<div ng-if="!loading &amp;&amp; !total">\n  <p><strong>No generators found!</strong></p>\n  <p>Or maybe the registry isn\'t up to date, try: <a href="https://www.npmjs.org/browse/keyword/slushgenerator">keyword \'slushgenerator\' at npm</a> instead</p>\n</div>\n<div ng-if="totalPages > 1" class="row text-center">\n  <div class="pagination">\n    <ul>\n      <li class="previous first"><a ng-click="getPage(1)"><span class="fui-arrow-left"></span><span class="fui-arrow-left"></span></a></li>\n      <li class="previous"><a class="fui-arrow-left" ng-click="getPage(page - 1)"></a></li>\n      <li ng-repeat="p in getPages()" ng-class="{\'active\': p === page}"><a ng-click="getPage(p)">{{p}}</a></li>\n      <li class="next"><a class="fui-arrow-right" ng-click="getPage(page + 1)"></a></li>\n      <li class="next last"><a ng-click="getPage(totalPages)"><span class="fui-arrow-right"></span><span class="fui-arrow-right"></span></a></li>\n    </ul>\n  </div>\n</div>\n';
